...
design_matrix <- design_matrix %>% mutate(OBP2A = recode(OBP2A, `-1_WT` = "Loss", `-2_WT` = "deep deletion",  
                                        `0_WT` = "WT", `1_WT` = "Gain", `2_WT` = "Amplification", `1_SNV` = "Gain & SNV"),
                         OBP2B = recode(OBP2B, `-1_WT` = "Loss",`-2_WT` = "Deep deletion", `0_WT` = "WT",
                                        `1_WT` = "Gain", `2_WT` = "Amplification", `1_SNV` = "Gain & SNV", `0_SNV` = "SNV"))
...
pdf("breast_cancer_obp_boxplot.pdf", height = 6, width = 12)
